...
class QueryInfer(object):
    ...
    def _make_sparse_tensor(self, query_logits, last_ys, last_xs, anchors, feature_value):
        ...
        sparse_tensor = torch.sparse_coo_tensor(sparse_indices.t(), sparse_features, (1, fh, fw), dtype=torch.float32)
        # sparse_tensor = spconv.SparseConvTensor(sparse_features, sparse_indices, (fh, fw), 1)
        # spconv.SparseConvTensor：feature, indices, spatial_shape, batch_size。注意SparseConvTensor的索引是转置的
